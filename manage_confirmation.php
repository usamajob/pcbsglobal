...
$sqsc1="select * from mdlitems_tb where pid='".$_REQUEST['dupid']."'";
$resc1=mysql_query($sqsc1) or die('error in data');

while($rwsc1=mysql_fetch_assoc($resc1)) {
$sqin1="insert into mdlitems_tb(qty,date,pid) values('".$rwsc1['qty']."','".$rwsc1['date']."','".$duplicate_corder_id."')";
$resin1=mysql_query($sqin1) or die('error in q');
}
...
<tr>
  <td align="center" valign="top" style="line-height: 16px;"><a href="welcome.php">Welcome To Admin Panel <br />
	...
	<td align="left" style="line-height: 16px;"><?php
...
if(isset($_REQUEST['btncus'])) {
	...
	$sqs = "select * from corder_tb where customer like '%".$srchc."%'";
		...
		$sqs = "select * from corder_tb where part_no like '%".$pno."%'";
		//echo $sqls;
		//$sqs.=" ORDER BY poid desc LIMIT $offset, $rowsPerPage ";
	...
	//print $query;
		...
		if ($pageNum < $maxPage) { 
			...
			<tr>
				...
				<td height="30" colspan="6" align="center"><a href="add_confirmation.php">Add Confirmation</a></td>
			</tr>
			<tr>
