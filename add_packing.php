...
while($temprow=mysql_fetch_assoc($res_tempprof2)){
	$reqs = addslashes($temprow['reqs']);
	$sql_prof3 = "INSERT INTO profile_tb3 (invoice_id,custid,profid,reqs,selectable,viewable,profile_tb3.check,check2) VALUES (".$invoice_id.",".$_POST['customer'].",".$temprow['profid'].",'".$reqs."',".$temprow['selectable'].",'".$temprow['viewable']."',".$temprow['check'].",".$temprow['check2'].")";
...
function test(){
	...
	var showlink = geturl("getRequirements2.php?ftype=pac&cid="+uid);
