...
$sqdel='delete from data_tb where data_id="'.$_REQUEST['delid'].'"';
...
if(answer) {
location.href="manage_data.php?delid="+id;
}
else
{
return false;
...
<tbody><tr>
	...
	<tr>                               
		...
		<tr>
			...
			<table class="manageTop" width="500" border="0"  cellpadding="2" cellspacing="2" bordercolor="#fff">
			...
			<tr>
				...
				<?php 
				$sqc="select DISTINCT c_name from data_tb order by c_name";
...
$sqs="select * from data_tb where c_name='".$_REQUEST['txtcname']."'";
...
if($_REQUEST['txtcname']!="")
{
	$query="select * from data_tb where c_name='".$_REQUEST['txtcname']."'";
}
...
<tr>
	<td height="30" colspan="5"><strong>MANAGE DATA </strong></td>
</tr>
...
<tr>
	...
	<td height="30" align="center"><a href="edit_data.php?id=<?php echo $rwc['data_id'];?>">Edit</a></td>
