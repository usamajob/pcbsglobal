                                                ...
                                                <table align="left" cellpadding="5" cellspacing="1" width="100%" style="position: relative; top: -20px; margin-left:0px">
                                                    <tbody>
                                                        ...
                                                        $sqs = "select  b.poid,
                                                                    ...
                                                                    from  porder_tb b 
                                                                    LEFT  OUTER JOIN invoice_tb c  on (b.part_no = c.part_no and b.rev = c.rev or b.po = c.po)
...
# An odd row
                ...
                $sql_pack = "SELECT COUNT(*) as cnt ,p.date1,p.svia,p.delto,p.po FROM porder_tb o,packing_tb p WHERE p.rev='$rev' and p.part_no='$pno' ";
