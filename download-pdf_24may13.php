...
<table  border="1">
  <tr>
    <td style="width:135px" >PCB Type: <strong>'.$nol.'</strong> Lyr</td>
...
$message  =$message.'	
   ...
   <td style="width:120px">IPC Class:  <strong>'.$rws[ipc_class].'</strong></td>
  </tr>
  <tr>
...
$message  =$message.'	<strong>'.$rws[array_size1].' X '.$rws[array_size2].' ('.$rws[b_per_array].') Up</strong> ';
  ...
  <tr>
    <td  colspan="5" style="padding-top:5px;"><strong><span style="padding-top:15px;">Special Requirements / Notes</span></strong>:<br/>';  
