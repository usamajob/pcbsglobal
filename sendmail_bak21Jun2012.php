...
in_board,array_rail,xouts,xouts1,rosh_cert,ord_date,cancharge,ccharge,orddate1,price,price1,price2,price3,price4,qty1,qty2,qty3,qty4,day1,day2,day3,day4,con_impe1,day5,qty5,qty6,qty7,qty8,qty9,qty10,new_or_rep) values('".$_REQUEST['txtcust']."','".$_REQUEST['txtpno']."','".$_REQUEST['txtrev']."','".$_REQUEST['txtreq']."','".$_REQUEST['txtemail']."','".$_REQUEST['txtphone']."','".$_REQUEST['txtfax']."','".$_REQUEST['txtqnt']."','".$_REQUEST['txtlead']."','".$_REQUEST['txtquote']."','".$_REQUEST['txtinst']."','".$ipc_class."','".$no_layer."','".$m_require."','".$thick_ness."','".$thick_tole."','".$inner_copper."','".$start_cu."','".$plated_cu."','".$fingers_gold."','".$trace_min."','".$space_min."','".$con_impe_sing."','".$con_impe_diff."','".$tore_impe."','".$hole_size."','".$pad."','".$blind."','".$buried."','".$bb_both."','".$hdi_design."','".$finish."','".$mask_size."','".$mask_type."','".$color."','".$ss_side."','".$ss_color."','".$route."','".$b_size1."','".$b_size2."','".$array."','".$b_per_array."','".$array_size1."','".$array_size2."','".$route_tole."','".$array_design."','".$design_array."','".$array_type1."','".$array_type2."','".$array_type3."','".$array_require1."','".$array_require2."','".$array_require3."','".$bevel."','".$counter_sink."','".$cut_outs."','".$slots."','".$logo."','".$mark."','".$date_code."','".$other_marking."','".$micro_s."','".$test_stamp."','".$in_board."','".$array_rail."','".$xouts."','".$xouts1."','".$rosh."','".date('m/d/Y')."','".$_REQUEST['cancharge']."','".$_REQUEST['ccharge']."','".$_REQUEST['orddate1']."','".$price."','".$price1."','".$price2."','".$price3."','".$price4."','".$_REQUEST['txtqty1']."','".$_REQUEST['txtqty2']."','".$_REQUEST['txtqty3']."','".$_REQUEST['txtqty4']."','".$_REQUEST['txtday1']."','".$_REQUEST['txtday2']."','".$_REQUEST['txtday3']."','".$_REQUEST['txtday4']."','".$con_impe1."','".$day5."','".$qty5."','".$qty6."','".$qty7."','".$qty8."','".$qty9."','".$qty10."','".$_POST['nor']."')";
...
$sqin="update order_tb set cust_name='".$_REQUEST['txtcust']."',part_no='".$_REQUEST['txtpno']."',rev='".$_REQUEST['txtrev']."',req_by='".$_REQUEST['txtreq']."',
		...
		con_impe1='".$con_impe1. "',new_or_rep='".$_POST['nor']. "',necharge='".$_REQUEST['necharge']. "',descharge='".$_REQUEST['descharge'].  "' where ord_id='".$_REQUEST['id']."'";
...
in_board,array_rail,xouts,xouts1,rosh_cert,ord_date,cancharge,ccharge,orddate1,price,price1,price2,price3,price4,qty1,qty2,qty3,qty4,day1,day2,day3,day4,con_impe1,day5,qty5,qty6,qty7,qty8,qty9,qty10,new_or_rep,cpo,opo) values('".$_REQUEST['txtcust']."','".$_REQUEST['txtpno']."','".$_REQUEST['txtrev']."','".$_REQUEST['txtreq']."','".$_REQUEST['txtemail']."','".$_REQUEST['txtphone']."','".$_REQUEST['txtfax']."','".$_REQUEST['txtqnt']."','".$_REQUEST['txtlead']."','".$_REQUEST['txtquote']."','".$_REQUEST['txtinst']."','".$ipc_class."','".$no_layer."','".$m_require."','".$thick_ness."','".$thick_tole."','".$inner_copper."','".$start_cu."','".$plated_cu."','".$fingers_gold."','".$trace_min."','".$space_min."','".$con_impe_sing."','".$con_impe_diff."','".$tore_impe."','".$hole_size."','".$pad."','".$blind."','".$buried."','".$bb_both."','".$hdi_design."','".$finish."','".$mask_size."','".$mask_type."','".$color."','".$ss_side."','".$ss_color."','".$route."','".$b_size1."','".$b_size2."','".$array."','".$b_per_array."','".$array_size1."','".$array_size2."','".$route_tole."','".$array_design."','".$design_array."','".$array_type1."','".$array_type2."','".$array_type3."','".$array_require1."','".$array_require2."','".$array_require3."','".$bevel."','".$counter_sink."','".$cut_outs."','".$slots."','".$logo."','".$mark."','".$date_code."','".$other_marking."','".$micro_s."','".$test_stamp."','".$in_board."','".$array_rail."','".$xouts."','".$xouts1."','".$rosh."','".date('m/d/Y')."','".$_REQUEST['cancharge']."','".$_REQUEST['ccharge']."','".$_REQUEST['orddate1']."','".$price."','".$price1."','".$price2."','".$price3."','".$price4."','".$_REQUEST['txtqty1']."','".$_REQUEST['txtqty2']."','".$_REQUEST['txtqty3']."','".$_REQUEST['txtqty4']."','".$_REQUEST['txtday1']."','".$_REQUEST['txtday2']."','".$_REQUEST['txtday3']."','".$_REQUEST['txtday4']."','".$con_impe1."','".$day5."','".$qty5."','".$qty6."','".$qty7."','".$qty8."','".$qty9."','".$qty10."','".$_POST['nor']."','".$_POST['cpo']."','".$_POST['opo']."')";
