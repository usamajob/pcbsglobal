...
$sqin="insert into packing_tb(vid,sid,namereq,svia,fcharge,city,state,sterm,comments,podate,customer,cusaccno,part_no,rev,delto,date1,odate,dweek,po,our_ord_num,saletax,no_layer) values('".$_REQUEST['vid']."','".$_REQUEST['sid']."','".$_REQUEST['namereq']."','".$_REQUEST['svia']."','".$_REQUEST['fcharge']."','".$_REQUEST['city']."','".$_REQUEST['state']."','".$_REQUEST['sterms']."','".$_REQUEST['area1']."','".date('m/d/Y')."','".$_REQUEST['customer']."','".$_REQUEST['cusaccno']."','".$_REQUEST['part_no']."','".$_REQUEST['rev']."','".$_REQUEST['delto']."','".$_REQUEST['date1']."','".$_REQUEST['odate']."','".$dweek."','".$_REQUEST['po']."','".$_REQUEST['oo']."','".$_REQUEST['stax']."','".$_REQUEST['lyrcnt']."')";
...
xmlhttp.send();
 ...
 Welcome To Admin Panel <br />
                                              <br /><img src="logo-pcb.png" width="189" height="198" border="0" /></a></td>
												<td valign="top" style="line-height: 16px;"><form name="form1" method="post" action="">
