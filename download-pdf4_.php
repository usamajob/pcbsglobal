...
//$pdf->Output($filename,'D');
 ...
 // $html2pdf->Output($filename);
  $filename="confirmationpdf/OC-$po-$rws[customer]-$rws[part_no]-$rws[rev]-$rwv[c_shortname] ".date("m-d-Y") . ".pdf";
  
$html2pdf->Output($filename,'F');
  
  $filename="OC-$po-$rws[customer]-$rws[part_no]-$rws[rev]-$rwv[c_shortname] ".date("m-d-Y") . ".pdf";
