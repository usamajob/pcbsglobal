...
<tbody><tr><td align="center" id="container">
...
<tr>
	...
	<td height="30"><label><select name="sterms" id="sterms">
...
<tr>
  ...
  <td height="30" colspan="2"><table width="690" border="0">
	...
	<tr>
	  ...
	  <td width="100" height="30">QTY Shipped</td>
	  <td width="60" height="30">Unit Price </td>
...
while($rwi = mysql_fetch_assoc($resi)) { ?>
	...
	<tr>
	  <td height="30"><label><input name="item_<?php echo $i;?>" type="text" value="<?php echo $rwi['item']; ?>"  id="itemname[]" size="30"></label></td>
	  <td height="30"><input name="desc_<?php echo $i;?>" value="<?php echo $rwi['itemdesc']; ?>" type="text" id="desc[]" size="30"></td>
	  <td height="30"><input name="qty_<?php echo $i;?>" value="<?php echo round_num($rwi['qty2']); ?>" type="text" id="qty_<?php echo $i;?>" size="15" class="cprice"></td>
	  <td height="30"><input name="uprice_<?php echo $i;?>" type="text" id="uprice_<?php echo $i;?>" size="15" value="<?php echo format_num($rwi['uprice']); ?>" class="cprice"></td>
	  <td height="30" class="ctr"><input name="icomm_<?php echo $i ?>" type="checkbox" id="icomm_<?php echo $i ?>" value="<?php echo $i ?>" class="icomm" <?php echo ($rwi['commision'] == '1' ? ' CHECKED ' : '') ?> ></td>
	</tr>
<?php 
	...
	<tr>
	  ...
	  <td height="30"><input name="qty_<?php echo $i; ?>" type="text" id="qty_<?php echo $i; ?>" size="15" class="cprice" ></td>
	  <td height="30"><input name="uprice_<?php echo $i; ?>" type="text" id="uprice_<?php echo $i; ?>" size="15" class="cprice" ></td>
	  <td height="30" class="ctr"><input name="icomm_<?php echo $i ?>" type="checkbox" id="icomm_<?php echo $i ?>" value="<?php echo $i ?>" class="icomm" ></td>
	</tr>
