...
$sqs = "select * from porder_tb where cancel != '1' AND YEAR(real_date) = 2017";
...
if(isset($_REQUEST['btncus'])) {
	...
	$sqs = "select * from porder_tb where cancel != '1' and customer like '%".$srchc."%' and year(porder_tb.real_date) = 2017";
	$sqs .= " ORDER BY poid desc LIMIT $offset, $rowsPerPage ";
}
...
$fixed_end_date = $explode_end_date[2]."-".$explode_end_date[0]."-".$explode_end_date[1];
	...
	$sqs = "select * from porder_tb, vendor_tb where cancel != '1' and porder_tb.vid = vendor_tb.data_id and year(porder_tb.real_date) = 2017 and porder_tb.real_date between '".$fixed_start_date."' and '".$fixed_end_date."'";
...
$fixed_start_date = $explode_start_date[2]."-".$explode_start_date[0]."-".$explode_start_date[1];
	...
	$sqs = "select * from porder_tb, vendor_tb where cancel != '1' and porder_tb.vid = vendor_tb.data_id and year(porder_tb.real_date) = 2017 and porder_tb.real_date >= '".$fixed_start_date."'";
	$sqs.=" ORDER BY porder_tb.poid desc LIMIT ".$offset.",".$rowsPerPage;
}
...
// print the navigation link 
	...
	<tr>
	  <td height="30" colspan="4"><font size="3"><strong>Manage Orders Placed</strong></font></td>
	  ...
	  <td height="30" colspan="3"> <a href="2017_purchase_report.php?start_date=<?php echo $_REQUEST['start_date'] ?>&end_date=<?php echo $_REQUEST['end_date'] ?>">Generate Orders Report</a></td>
	</tr>
	<tr>
