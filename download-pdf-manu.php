...
<table  width="1500px" border="0"  >
   <tr> 
    <td style="width:200px"><img src="images/logo.jpg" width="50px" height="40px" style="width:160px; height:180px; " alt="PCBsGlobal Inc. Logo"></td>  
  ...
  <tr  style="background-color:#656BBC; color:#FFF; text-align: center; font-size: 18pt;">
   ...
   <tr>
	...
	if ($rws[cancharge] == 'yes') {
		$message  = $message.'<td><b>Cancellation Charge: </b> $ '.$rws[ccharge].'  </td>
	   <td></td>';
	}
	else 
...
<tr><td colspan="4" width="750" height="3px" ></td></tr>
</table>
';
...
$message  =$message.'
	...
	<td style="width:130px">FOB:  <strong>'.$rws[fob].'</strong>&nbsp;';	
...
if($rws[cancharge] != 'yes') {
	...
	if($rws[descharge] != 0.00 || $rws[descharge1] != "" || $rws[descharge2] != "" || $rws[necharge] != 0.00) $message = $message.'
    <table border="1" cellspacing="0"><tr>';

	if($rws[necharge] != 0.00)
		$message = $message.'<td width="150">&nbsp;<b>NRE: </b>&nbsp;$'.$rws[necharge].'</td>';

	if($rws[desdesc] != "" && $rws[descharge] != 0.00)
		$message = $message.'<td width="200">&nbsp;<b>'.$rws[desdesc].':</b>&nbsp;$'.$rws[descharge].'</td>';

	if($rws[desdesc1] != "" && $rws[descharge1] != "")
		$message = $message.'<td width="200">&nbsp;<b>'.$rws[desdesc1].':</b>&nbsp;$'.$rws[descharge1].'</td>';

	if($rws[desdesc2] != "" && $rws[descharge2] != "")
		$message = $message.'<td width="200">&nbsp;<b>'.$rws[desdesc2].':</b>&nbsp;$'.$rws[descharge2].'</td>';
...
if ($rws[cancharge] != 'yes') {
  ...
  if($rws[day1] > 0 || $rws[day2] > 0 || $rws[day3] > 0 || $rws[day4] > 0 || $rws[day5] > 0) {
	  $message  = $message.'
...
$message  = $message.'  </tr>'; 
  ...
  if($rws[day1] > 0 || $rws[day2] > 0 || $rws[day3] > 0 || $rws[day4] > 0 || $rws[day5] > 0) $message  =$message.'</table>'; 
