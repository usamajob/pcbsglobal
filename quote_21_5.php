...
?>
 ...
 &nbsp;&nbsp;&nbsp;
  ...
  <input type="radio" name="nor1" value="Repeat With Change"   id="repwc" /></td>
    </tr>
...
*/
      ...
      <br />
     <div id="misc1" style="visibility:hidden;"><strong>Misc Charge1:</strong> <input size=3 type=text name=descharge value='' id=descharge> 
       &nbsp;Name of Misc1 :
       <input type=text name=desdesc id=desdesc />
     </div>
      <div id="misc2" style="visibility:hidden;">  <strong>Misc Charge2:</strong> <input size=3 type=text name="descharge1" value="" id="descharge1"> 
       &nbsp;Name of Misc2 :
       <input type=text name=desdesc1 id=desdesc1 />
      </div>
       <div id="misc3" style="visibility:hidden;"> <strong>Misc Charge3:</strong> <input size=3 type=text name="descharge2" value="" id="descharge2"> 
       &nbsp;Name of Misc3 :
       <input type=text name=desdesc2 id=desdesc2 />
       </div>
