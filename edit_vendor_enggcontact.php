...
if(isset($_POST['Submit']))
{
 ...
 $sqin="update vendor_enggcont_tb set name='".$_POST['txtename']."',lastname='".$_POST['txtelname']."',email='".$_POST['txteemail']."',phone='".$_POST['txtephone']."',mobile='".$_POST['txteemob']."',coustid='".$_POST['cid']."' where enggcont_id ='".$_POST['cousid']."'";
...
$sqs="select * from vendor_enggcont_tb where enggcont_id='".$_REQUEST['id']."'";
...
<input type="hidden" value="<?php echo $_REQUEST['id'];?>" name="cousid" id="cousid">
                                                  ...
                                                  <table class="manageTop" width="500" border="1" cellpadding="2" cellspacing="2" bordercolor="#e6e6e6">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td height="30" colspan="2"><strong>EDIT VENDOR ENGINEERING CONTACT</strong></td>
