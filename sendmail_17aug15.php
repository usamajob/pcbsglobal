...
if(isset($_REQUEST['Submit'])) {	
	...
	$asql = "update alerts_tb set customer='".trim($arr[1])."', part_no='".trim($_REQUEST['txtpno'])."', rev='".trim($_REQUEST['txtrev'])."' where refid = '".$_SESSION['refid']."'";
	//
	...
	if($_REQUEST['chk200']!="") { $hdi_design = $_REQUEST['chk200']; }
	if($_REQUEST['chk201']!="") { $hdi_design=$_REQUEST['chk201']; }

	if($_REQUEST['chk210']!="") { $cond_vias=$_REQUEST['chk210']; }
	if($_REQUEST['chk211']!="") { $cond_vias=$_REQUEST['chk211']; }

	if($_REQUEST['chk215'] != "") { $resin_filled = $_REQUEST['chk215']; }
	if($_REQUEST['chk216'] != "") { $resin_filled = $_REQUEST['chk216']; }
...
<strong>Rout Tolerance :</strong> 
    ...
    <td height=30><strong>Array Design Provided:</strong> $_REQUEST[chk65] $_REQUEST[chk66]
      <br />
 ...
 <br />   
  ...
  <tr>
    ...
    <td height=30><strong>Logo:</strong> 
      ...
      $_REQUEST[chk83] $_REQUEST[chk84]    

      <br />

      <strong>94V-0 Mark: </strong>

      $_REQUEST[chk85]<br> $_REQUEST[chk86] <strong><br />
    ...
    <td height=30><strong>X-Outs Allowed:</strong> 
      ...
      $_REQUEST[chk97] $_REQUEST[chk98]      </td>
