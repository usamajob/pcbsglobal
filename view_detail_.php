...
<meta http-equiv="content-type" content="text/html; charset=ISO-8859-1">
  ...
  <table width="920" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#e6e6e6">
    <tr>
    ...
    <tr>
      <td height="30" colspan="3"><strong>FAX : </strong><?php echo $rws['fax'];?> <strong>Quntity :</strong><?php echo $rws['fax'];?><strong> Lead Times :</strong> 
        <?php echo $rws['lead_times'];?>      <strong> Quote Needed by:      </strong><?php echo $rws['quote_by'];?></td>
    </tr>
...
<br />
      ...
      <td height="30" valign="top"><strong>Smallest  Hole Size:</strong><?php echo $rws['hole_size'];?><br /><strong>
...
<strong>HDI Design:</strong><?php echo $rws['hdi_design'];?></td>
    ...
    <tr>
      <td height="30"><strong>Individual Route 1-up:<?php echo $rws['route'];?></strong><br />
        <br />
        ...
        <br />
        <strong>Array:</strong> <?php echo $rws['array'];?><br />
        <strong>Bds Per Array :</strong><?php echo $rws['b_per_array'];?><br />
        <strong>Array Size:        </strong>
        <?php echo $rws['array_size1'];?>
X
<?php echo $rws['array_size2'];?>	<br />
	<strong>Rout Tolerance :</strong><?php echo $rws['route_tole'];?></td>
      <td height="30"><strong>Array Design Provided:</strong><?php echo $rws['array_design'];?><br />
        <strong><br />
        Factory to Design Array: </strong><?php echo $rws['design_array'];?><br />
    ...
    <tr>
      ...
      <td height="30"><strong>X-Outs Allowed:</strong><?php echo $rws['xouts'];?><br />
        <br />
        <strong># of X-outs per Array :</strong><?php echo $rws['xouts1'];?><br />
