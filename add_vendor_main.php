...
{
$sqin="insert into vendor_maincont_tb(name,lastname,phone,email,mobile,coustid) values('".$_REQUEST['txtename']."','".$_REQUEST['txtelname']."','".$_REQUEST['txtephone']."','".$_REQUEST['txteemail']."','".$_REQUEST['txteemob']."','".$_REQUEST['cid']."')";
$resin=mysql_query($sqin);
if(!$resin)
{
die('error in data'.mysql_error());
}
header('location:manage_vendor_main.php');
}
$title = "Add Vendor Main Contact";
												...
												<td style="line-height: 16px;"><form name="form1" method="post" action="">
                                                  ...
                                                  <table class="manageTop" width="500" border="1" cellpadding="2" cellspacing="2" bordercolor="#e6e6e6">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td height="30" colspan="2"><strong>ADD VENDOR MAIN CONTACT</strong></td>
