        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tbody><tr>
                ...
                <td align="center">
                    ...
                    <table width="1000" bgcolor="#999999" border="0" cellpadding="0" cellspacing="1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="side" style="width: 250px;" width="250"><?php require_once('leftmenu.php'); ?></td>
...
?>
  ...
  <table width="880" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#e6e6e6">
    ...
    <tr>
      ...
      <label>
                                                        ...
                                                        <select name="txtcust" id="txtcust">
                                                        ...
                                                        <option value="<?php echo $rwv['c_name'];
      ...
      <td width="310"><strong>Part Number :</strong> 

      <input type="text" name="txtpno" id="txtpno" /></td>

      <td width="240"><strong>Rev :</strong> 

      <input type="text" name="txtrev" id="txtrev" /></td>
    ...
    <tr>
      ...
      <input type="text" name="txtreq" id="txtreq" /></td>

      <td height="30"><strong>Email :</strong> 
    ...
    <tr>
      ...
      <strong> NRE Charge:</strong> <input size="3" type="text" value="" name="necharge" id="necharge"><strong>Misc Charge:</strong> <input size="3" type="text" name="descharge" value="" id="descharge"> 
...
<tr>
      ...
      <font color="white"><strong>ADMIN INSTRUCTIONS: </strong></font></span>
 ...
 <td height="30" bgcolor=#336699  align="Left">
	...
	<br>
        No &nbsp;&nbsp;<input name="admcmntstat" type="radio" id="admcmntstat2" checked value="no" />
  ...
  <table width="880" border="1" style="border-color: 
#336699;" align="center" cellpadding="1" cellspacing="0" bordercolor="#e6e6e6">
...
<br /></td>
    ...
    <tr>
      ...
      <td height="30" width="307px"><strong>Start Cu Oz:</strong> .5/.5
        <input name="chk10" type="radio" id="chk10" value=".5/.5" />
		&nbsp;
1/1
<input name="chk10" type="radio" id="chk11" value="1/1" />
&nbsp;
2/2
<input name="chk10" type="radio" id="chk12" value="2/2" />
<br />
<br />
Other :
...
&nbsp;		
      ...
      <td height="30"><strong>Mask Sides:</strong> N/A
		...
		&nbsp;
      Matte 
      <input name="chk53" type="radio" id="chk54" value="Matte " />
    </td>
      ...
      <td height="30" width="273px"><strong>S/S Sides: </strong>N/A 
        ...
        <input name="chk58" type="radio" id="chk58" value="Wht" />
		&nbsp;
        Black 
        <input name="chk58" type="radio" id="chk59" value="Blk" />
		&nbsp;
...
<input name="txtother16" type="text" id="textfield25" size="5" />
	...
	<strong>Rout Tolerance:</strong>
      ...
      <input name="txtother52" type="text" id="txtother53" size="5" />
    </td>
    ...
    <tr>
	  ...
	  &nbsp;
      In Array Rail
      <input name="chk94" type="radio" id="chk199" value="In Array Rail " />
