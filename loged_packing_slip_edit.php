...
if(isset($_REQUEST['Submit'])) {
    ...
    $qty_shipped = addslashes($_POST['qty_shipped']); 
     ...
     $sql_insert = "UPDATE  packing_tb_loged ";
    $sql_insert.="SET  ";
    $sql_insert.= "our_po = '".$our_po."',";
    $sql_insert.= "customer = '".$customer."',";
    $sql_insert.= "part_no = '".$part_no."',";
	$sql_insert.= "supplier = '".$supplier."',";
	$sql_insert.= "rev = '".$rev."',";
	$sql_insert.= "rec_on = '".$rec_on."',";
	$sql_insert.= "otd = '".$otd."',";
	$sql_insert.= "customer_po = '".$customer_po."',";
	$sql_insert.= "cus_due_date = '".$cus_due_date."',";
	$sql_insert.= "qty_ordered = '".$qty_ordered."',";
	$sql_insert.= "qty_rec = '".$qty_rec."',";
	$sql_insert.= "qty_due = '".$qty_due."',";
	$sql_insert.= "shipped_on = '".$shipped_on."',";
	$sql_insert.= "qty_insp = '".$qty_insp."',";
	$sql_insert.= "qty_passed = '".$qty_passed."',";
	$sql_insert.= "inspected_by = '".$inspected_by."',";
	$sql_insert.= "solder_sample = '".$solder_sample."',";
	$sql_insert.= "ncr = '".$ncr."',";
	$sql_insert.= "qty_shipped = '".$qty_shipped."',";
	$sql_insert.= "comment = '".$comment."' WHERE id = ".$_REQUEST['id'];

	$res_insert = mysql_query($sql_insert);

	?>
	<script type="text/javascript">
		window.location.replace('loged_packing_slip_list.php');
	</script>
	<?php
...
<?php 
$sql = "SELECT * FROM packing_tb_loged WHERE id = ".$_REQUEST['id'];
$res = mysql_query($sql);
...
<tr>
			...
			<td height="30">
			<input type="text" value="<?php echo $row['our_po']; ?>" name="part_no11" id="part_no11" onChange="setTimeout(function() {test();},250);" size="30" /></td>
		</tr>
</table>
...
<td height="30"><select name="supplier" >
		...
		while($rwv = mysql_fetch_array($resv)) {
		?>
			<option value="<?php echo $rwv['data_id']; ?>" <?php if($rwv['data_id']== trim($row['supplier'])){echo "selected=selected";} ?>><?php echo $rwv['c_name']; ?></option>
		<?php 
...
<td height="30"><input type="text" name="rev" value="<?php echo $row['rev']; ?>"></td>
</tr>
<tr>
	</td>
...
<td height="30">
	...
	<input type="text" name="rec_on" id="" value="<?php echo $row['rec_on']; ?>">
</td>
</tr>
<tr>
	</td>
...
<td height="30">
	<select name="otd">
		<option value="Yes" <?php if($row['otd']=='yes'){echo "selected=selected";} ?>>Yes</option>
		<option value="No" <?php if($row['otd']=='No'){echo "selected=selected";} ?>>No</option>
	</select>
</td>
</tr>
<tr>
...
<td height="30">
	<input type="text" name="customer_po" value="<?php echo $row['customer_po']; ?>">
</td>
</tr>
<tr>
	</td>
...
<td height="30">
	<?php  $date = explode("-",$row['cus_due_date']); 
			$date1 = $date[1]."/".$date[2]."/".$date[0];
	?>
	<input type="text" name="cus_due_date"  value="<?php echo$date1; ?>" id="exampleII">
</td>
</tr>
<tr>
<tr>
...
<td height="30">
	<input type="text" name="qty_ordered" value="<?php echo $row['qty_ordered']; ?>" >
</td>
</tr>
</table>
</div>
...
<td height="30">
	<input type="text" name="qty_rec" value="<?php echo $row['qty_rec']; ?>" >
</td>
</tr>
<tr>
	</td>
	...
	<td height="30">
		<input type="text" name="qty_due" id="" value="<?php echo $row['qty_due']; ?>">
	</td>
</tr>
<tr>
	</td>
	...
	<td height="30">
		<input type="text" name="qty_shipped" value="<?php echo $row['qty_shipped']; ?>">
	</td>
</tr>
<tr>
	</td>
...
<td height="30">
	<?php  $date = explode("-",$row['shipped_on']); 
			$date1 = $date[1]."/".$date[2]."/".$date[0];
	?>
	<input type="text" name="shipped_on" id="exampleIII" value="<?php echo $date1; ?>">
</td>
</tr>
<tr>
	</td>
...
<td height="30">
	<input type="text" name="qty_insp" value="<?php echo $row['qty_insp']; ?>">
</td>
</tr>
<tr>
	</td>
...
<td height="30">
	<input type="text" name="qty_passed" value="<?php echo $row['qty_passed']; ?>" >
</td>
</tr>
<tr>
	</td>
...
<td height="30">
	<input type="text" name="inspected_by" value="<?php echo $row['inspected_by']; ?>">
</td>
</tr>
<tr>
	</td>
...
<td height="30">
	<input type="text" name="solder_sample" value="<?php echo $row['solder_sample']; ?>">
</td>
</tr>
<tr>
	</td>
...
<td height="30">
	<input type="text" name="ncr" value="<?php echo $row['ncr']; ?>">
</td>
</tr>
<!-- <tr>
	</td>
...
<td height="30">
	<input type="text" name="revision_level" value="<?php echo $row['rev_level']; ?>"  >
</td>
</tr> -->
<tr>
	</td>
...
<td height="30">
	<textarea type="text" name="comment" ><?php echo $row['comment']; ?></textarea>
</td>
</tr>
