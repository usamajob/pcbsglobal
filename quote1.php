...
$(function() {
    $(document).keypress(function(event) {
        ...
        switch (ch) {
            ...
            case 'm': case 'M':
                window.location.href = 'http://pcbsglobal.com/luke-new/admin/manage_quote.php';
                break;
        }
    });
});
...
?>
  ...
  <table width="880" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#e6e6e6" class="up">
    ...
    <tr>
      ...
      <input type="text" name="txtpno" id="txtpno" onFocus="var tfocus='yes';" /></td>
