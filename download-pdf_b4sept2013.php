...
if(strtolower($resin_filled)  ==  "yes") {
	$optcount++;
	$option_arr[$optcount] = 'Resin Filled/Capped Vias Required';
}
...
if($color != '' && $mask_size != "N/A") {
	$option_arr[$colorcnt] = $color.' '.$option_arr[$colorcnt];
}
...
$message  =$message.'
 ...
 <tr>
    <td colspan="2" style="text-align:right"><strong>NRE & Misc Charges Included&nbsp;</strong></td>
    ';
