...
$inv = $rws['inv_id'];
$cf = $rws['credit_id'] + 10098;
$arr1 = explode("-", $rws['credit_date']);
...
<table  width="1500px" border="0">
   <tr> 
	...
	<td width="200"></td>
	<td> <h1 style="font-size: 40pt;color:#5660B1"   >Credit</h1>
	<br>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;
	<strong>CREDIT OFFSET #    </strong> '.$cf.'<br>	
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;
	<strong>CREDIT DATE:   </strong>'.$dtt.'<br>	
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;
...
$messagee .= '  '.
	...
	<td  width="90"   align="right" style="text-align:right">  $'.format_num(str_replace(',', '', $rwi[uprice])).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td  width="75"   align="right" style="text-align:right">  $'.format_num(str_replace(',', '', $rwi[tprice])).'&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>'; 
...
$tot = str_replace(',', '',  $tot);
$st = number_format(intval($rws['saletax']), 4 );
$taxx = $tot * $st;
...
</table><br><br><table width="1500px" border="0">
<tr> 
...
<strong>Comments</strong><br>'.$rws[comments]. '<br> <br>Direct All Inquiries To <br>  
	Armando Torres <br>  
	714-553-7047<br> 
	armando@pcbsglobal.com<br></td>
	<td  width="100" ></td>
	<td  width="200">
...
if ($_REQUEST['oper'] == 'view') {
	...
	$filename = "invoicepdf/credit-$inv-$rws[customer]-$rws[part_no]-$rws[rev] ".date("m-d-Y") . ".pdf";
