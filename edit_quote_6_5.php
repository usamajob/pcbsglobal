...
$j('#content2').html(geturl("getmailphone.php?uid="+uid));  
  ...
  <table width="920" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#e6e6e6" style="left:35px;">
    ...
    <tr>
      ...
      <td width="250"><strong>Rev :</strong>
 ...
 &nbsp;&nbsp;&nbsp;
  ...
  <input type="radio" name="nor"  <?php if ($rws['new_or_rep']=='Repeat Order') echo 'checked';?> value="Repeat Order" id="rep" />
       &nbsp;&nbsp;&nbsp;
      <label for="rep"><strong> Repeat WC:</strong></label>
  <input type="radio" name="nor" value="Repeat With Change" <?php if ($rws['new_or_rep']=='Repeat With Change') echo 'checked';?>  id="repwc" />
...
-->
    ...
    <tr>
     ...
     <!-- <strong>Quntity :</strong>
      ...
      <strong> NRE Charge:</strong> <input size="3" type="text" value="<?php echo $rws['necharge'];?>" name="necharge" id="necharge"><strong>Misc Charge:</strong> <input size="3" type="text" name="descharge" value="<?php echo $rws['descharge'];?>" id="descharge">
