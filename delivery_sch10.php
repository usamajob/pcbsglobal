...
//                                                        LEFT  OUTER JOIN invoice_tb c  on (b.part_no = c.part_no and b.rev = c.rev and b.po = c.po )
                                                        ...
                                                        if (isset($_REQUEST['btnpart'])) {
                                                            ...
                                                            $sqs = "select  b.poid,b.namereq1, b.customer,b.namereq,b.part_no,b.rev,c.invoice_id,c.ord_by,b.allow,b.date1,c.delto,c.our_ord_num,c.svia,b.poid,b.po,b.sid,c.podate,c.invoice_id,b.dweek,
                                                                unix_timestamp(str_to_date(substr(b.date1,locate('-',b.date1)+1),'%m-%d-%Y')) as del_date,b.vid 
                                                                from  porder_tb b
                                                                LEFT  JOIN invoice_tb c  on (b.part_no = c.part_no and b.po = c.po )
                                                        ...
                                                        if (isset($_REQUEST['btnven'])) {
                                                            ...
                                                            //$sqs="select * from corder_tb where part_no ='".$pno."'";
                                                            echo $sqs = "select  b.poid,b.namereq1, b.customer,b.namereq,b.part_no,b.rev,c.invoice_id,b.allow,c.ord_by,b.date1,c.delto,c.our_ord_num,c.svia,b.poid,b.po,b.sid,c.podate,c.invoice_id,b.dweek,
                                                                unix_timestamp(str_to_date(substr(b.date1,locate('-',b.date1)+1),'%m-%d-%Y')) as del_date,b.vid 
                                                                from  porder_tb b 
        ...
        <div style="width:100%;">
            <div id="main">
                ...
                <div id="left" style="width:0.5%;"> WT </div>
...
//$query="select * from order_tb where ( req_by  LIKE '$ord_by') limit 1";
 ...
 <div id="left5" align="left"><form action="delivery_sch.php?act=<?php echo $rws['poid'];?>" method="post" name="formact"><input name="txtchk" type="checkbox" value="1"  onchange="this.form.submit();"  <?php if($rws['allow']==1){?>checked="checked" <?php } ?>/></form></div>
