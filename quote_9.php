...
?>
  ...
  <table width="880" border="1" cellpadding="1" cellspacing="1" bordercolor="#e6e6e6" class="up">
    ...
    <tr>
      ...
      <input type="text" name="txtrev" id="txtrev" /><label for="new"><strong><br />
      New</strong></label>
 ...
 &nbsp;&nbsp;&nbsp;
  ...
  <input type="radio" name="nor1"  value="Repeat Order" id="rep" />
       &nbsp;&nbsp;&nbsp;
      <label for="rep"><strong> <br />
      Repeat WC:</strong></label>
  <input type="radio" name="nor1" value="Repeat With Change"   id="repwc" />
</td>
...
#336699;" cellpadding="1" cellspacing="0" bordercolor="#e6e6e6">
