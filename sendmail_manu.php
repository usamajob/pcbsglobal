...
if(isset($_REQUEST['Submit'])) {	
	...
	$cancharge = isset($_REQUEST['cancharge']) ? $_REQUEST['cancharge'] : 'no';
	$admcmntstat = isset($_REQUEST['admcmntstat']) ? $_REQUEST['admcmntstat'] : 'no';

	//print_r($_REQUEST); exit;

	//update alerts with part no and rev for refid
	$asql = "update alerts_tb set part_no='".$_REQUEST['txtpno']."' where refid = '".$_SESSION['refid']."'";
	//, rev='".$_REQUEST['txtrev']."'
	...
	if(strtolower($xouts) == 'yes' && $_POST['txtother28'] != "") {
		$xouts1 = $_POST['txtother28'];
	}
...
values('".$txtcust."','".$_REQUEST['txtpno']."', '".$_REQUEST['txtrev']."','".$txtreq."','".$_REQUEST['txtemail']."','".$_REQUEST['txtphone']."','".$_REQUEST['txtfax']."','".$_REQUEST['txtqnt']."','".$_REQUEST['txtlead']."','".$_REQUEST['txtquote']."','" .$_REQUEST['necharge'] . "','" . $_REQUEST['descharge'] . "','" .$_REQUEST['txtinst'] . "','" .$_REQUEST['txtinstadmin'] . "','" .$admcmntstat."','".$ipc_class."','".$no_layer."','".$m_require."','".$thick_ness."','".$thick_tole."','".$inner_copper."','".$start_cu."','".$plated_cu."','".$fingers_gold."','".$trace_min."','".$space_min."','".$con_impe_sing."','".$con_impe_diff."','".$tore_impe."','".$hole_size."','".$pad."','".$blind."','".$buried."','".$hdi_design."','".$finish."','".$mask_size."','".$mask_type."','".$color."','".$ss_side."','".$ss_color."','".$route."','".$b_size1."','".$b_size2."','".$array."','".$b_per_array."','".$array_size1."','".$array_size2."','".$route_tole."','".$array_design."','".$design_array."','".$array_type1."','".$array_type2."','".$array_require1."','".$array_require2."','".$array_require3."','".$bevel."','".$counter_sink."','".$cut_outs."','".$slots."','".$logo."','".$mark."','".$date_code."','".$other_marking."','".$micro_s."','".$test_stamp."','".$in_board."','".$array_rail."','".$xouts."','".$xouts1."','".$rosh."','".date('m/d/Y')."','".$cancharge."','".$_REQUEST['ccharge']."','".$_REQUEST['fob']."','".$_REQUEST['orddate1']."','".$price."','".$price1."','".$price2."','".$price3."','".$price4."','".$_REQUEST['txtqty1']."','".$_REQUEST['txtqty2']."','".$_REQUEST['txtqty3']."','".$_REQUEST['txtqty4']."','".$_REQUEST['txtday1']."','".$_REQUEST['txtday2']."','".$_REQUEST['txtday3']."','".$_REQUEST['txtday4']."','".$con_impe1."','".$day5."','".$qty5."','".$qty6."','".$qty7."','".$qty8."','".$qty9."','".$qty10."','".$_POST['nor']."','".$_POST['changes']."',
...
$quoteid = mysql_insert_id();
	...
	$sqin = "update order_tb set cust_name='".$txtcust."', part_no='".$_REQUEST['txtpno']."',rev='".$_REQUEST['txtrev']."', req_by='".$txtreq."',
		...
		. "',pr81='".$_REQUEST['pr81']."', pr82='".$_REQUEST['pr82']. "',pr83='".$_REQUEST['pr83']."', pr84='".$_REQUEST['pr84']. "',pr85='".$_REQUEST['pr85']."', pr91='".$_REQUEST['pr91']. "', pr92='".$_REQUEST['pr92']."', pr93='".$_REQUEST['pr93']. "', pr94='".$_REQUEST['pr94']."', pr95='".$_REQUEST['pr95']. "', pr101='".$_REQUEST['pr101']."', pr102='".$_REQUEST['pr102']."', pr103='".$_REQUEST['pr103']. "', pr104='".$_REQUEST['pr104']."', pr105='".$_REQUEST['pr105']. "', descharge1='".$_REQUEST['descharge1']."', descharge2='".$_REQUEST['descharge2']."', sp_reqs = '".$sp_req."', comments='".$_POST['comments']."', simplequote = '".$simplequote."', fob_oth = '".trim($_POST['fob_oth'])."', vid='".$_POST['vid']."', 	vid_oth = '".trim($_POST['vid_oth'])."'
...
$message  ="<table width=820 border=1 align=center cellpadding=1 cellspacing=1 bordercolor=#e6e6e6>
  ...
  <tr>
    ...
    <td height=30 bgcolor=#0099CC><p><strong>IPC Class: </strong> $_REQUEST[chki1]
      ...
      $_REQUEST[chki2] $_REQUEST[chki3] </td>
  ...
  <tr>
    ...
    <br />
      ...
      <strong>Controlled Impedance:</strong> $con_impe1  <br />
	$_REQUEST[chk109] <br />
	$_REQUEST[chk110] <br />
  ...
  <tr>
    ...
    <td height=30><strong>Individual Route 1-up: </strong> $route <br /><br />
    ...
    X
      ...
      <br />
      <strong>Array Size: </strong> $_REQUEST[txtother15]        
    X $_REQUEST[txtother16]<br />      

<strong>Rout Tolerance :</strong> $_REQUEST[chk204]
      $_REQUEST[chk205]
	...
	<br />
      ...
      <strong><br />Factory to Design Array: </strong> $design_array 
      <br />
 ...
 <br />   
    ...
    <td height=30><strong>Bevel: </strong> $bevel
      ...
      <strong>Countersink:</strong> $counter_sink
      <br /><br />
      <strong>Cut Outs:</strong> $cut_outs <br /><br />
  ...
  <tr>
    ...
    <td height=30><strong>Logo:</strong> 
      ...
      <strong>94V-0 Mark: </strong> $mark <strong><br />
    ...
    <td height=30><strong>Microsection Required:</strong> $micro_s <br />

      <br />

      <strong>Electrical Test Stamp: </strong> $test_stamp <br />

      $_REQUEST[chk94]      

	 $_REQUEST[chk199]	</td>

    <td height=30><strong>X-Outs Allowed:</strong> $xouts
      <br /><br />
