...
if($_REQUEST['delid']!="")
{
$sqdel='delete from vendor_tb where data_id="'.$_REQUEST['delid'].'"';
...
location.href="manage_vendor.php?delid="+id;
												        ...
												        <table class="manageTop" width="500" border="1"  cellpadding="2" cellspacing="2" bordercolor="#e6e6e6">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td width="300" height="30"><select name="txtcname" id="txtcname" onChange="this.form.submit();">
                                                              ...
                                                              <?php 
														$sqc="select DISTINCT c_name from vendor_tb order by c_name";
...
$sqs="select * from vendor_tb";
$sqs.=" ORDER BY data_id desc LIMIT $offset, $rowsPerPage ";
if($_REQUEST['txtcname']!="")
{
$sqs="select * from vendor_tb where c_name='".$_REQUEST['txtcname']."'";
$sqs.=" ORDER BY data_id desc LIMIT $offset, $rowsPerPage ";
}
...
$query="select * from vendor_tb";
if($_REQUEST['txtcname']!="")
{
$query="select * from vendor_tb where c_name='".$_REQUEST['txtcname']."'";
}
	...
	<tr>
		<td height="30" colspan="5"><strong>MANAGE vendor </strong></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="247" height="30" align="center"><strong>Customer Name</strong></td>
		<td width="107" align="center"><strong>Engineer Contact Name</strong></td>
	...
	<tr>
		...
		<td height="30" align="center"><a href="edit_vendor.php?id=<?php echo $rwc['data_id'];?>">Edit</a></td>
...
?>
											      ...
											      <table width="600" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#e6e6e6">
                                                    <tr>
                                                      <td height="50"><strong>No vendor Available </strong></td>
                                                    </tr>
                                                  </table>
											      <p>
                                                    <?php 
