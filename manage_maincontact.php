...
$sqdel='delete from maincont_tb where enggcont_id="'.$_REQUEST['delid'].'"';
...
<head>
<title>Manage Main Contacts</title>
...
location.href="manage_maincontact.php?delid="+id;
...
<tr>
<td id="mainpage" style="width: 820px;">
<div>
...
$sqs = "select * from maincont_tb";
$sqs .= " ORDER BY enggcont_id desc LIMIT $offset, $rowsPerPage ";

if($_REQUEST['txtcname'] != "") {

	$sqs = "select * from maincont_tb where coustid='".$_REQUEST['txtcname']."'";
...
if(mysql_num_rows($res1) > 0) {
	...
	$query = "select * from maincont_tb";

	if($_REQUEST['txtcname'] != "") {
		$query = "select * from maincont_tb where coustid='".$_REQUEST['txtcname']."'";
	}
...
?>
	  ...
	  <table class="manage up" style="left:310px;" width="815" border="1" cellpadding="2" cellspacing="2" bordercolor="#e6e6e6" >

	  <tr>
		<td height="30" colspan="6"><strong>MANAGE Main Contacts </strong></td>
	  </tr>
	  ...
	  while($rwc=mysql_fetch_array($res1))  {
		...
		while($rwcc = mysql_fetch_array($rescc)) {
		  ...
		  <tr>
			...
			<td height="30" align="center"><a href="edit_maincontact.php?id=<?php echo $rwc['enggcont_id'];?>">Edit</a></td>

			<td height="30" align="center"><a href="#" onClick="del('<?php echo $rwc['enggcont_id'];?>');">Delete</a></td>
