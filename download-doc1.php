...
Fax: (855) 262-5305<br>	
  ...
  <table width="920px" border="0">
   <tr > 
    <td  width="300" style="background-color:#656BBC; color:#FFF;" colspan="2">VENDOR</td>  
	<td  width="50"></td>
...
Boards must be individually bagged and packages <br>
...
$filename="porderpdf/PO-$po-$rws[customer]-$rws[part_no]-$rws[rev]-$rwv[c_shortname] ".date("m-d-Y") . ".doc";
$fp = fopen( $filename, 'w');
fwrite($fp, $messagee);
$filename="PO-$po-$rws[customer]-$rws[part_no]-$rws[rev]-$rwv[c_shortname] ".date("m-d-Y") . ".doc";
