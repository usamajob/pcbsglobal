...
{
$sqin = "insert into enggcont_tb(name,lastname,phone,email,mobile,coustid) values('".$_REQUEST['txtename']."','".$_REQUEST['txtelname']."','".$_REQUEST['txtephone']."','".$_REQUEST['txteemail']."','".$_REQUEST['txteemob']."','".$_REQUEST['cid']."')";
$resin = mysql_query($sqin);
if(!$resin)
{
die('error in data'.mysql_error());
}
header('location:manage_enggcontact.php');
}

$title = "Add Eng Contact";
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tbody><tr>
                ...
                <td align="center">
                    ...
                    <table b border="0" cellpadding="0" cellspacing="1" width="1300">
												...
												<td style="line-height: 16px;"><form name="form1" method="post" action="">
                                                  ...
                                                  <table class="manageTop" width="500" border="1" cellpadding="2" cellspacing="2" bordercolor="#e6e6e6">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td height="30" colspan="2"><strong>ADD ENGINEERING CONTACT</strong></td>

                                                    </tr>
													
                                                     <tr>

                                                      <td height="30"><strong>Select Customer</strong></td>
