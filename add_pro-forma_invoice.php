...
if(isset($_POST['Submit'])) {
	...
	$sqin = "insert into invoice_tb (vid, sid, namereq, svia, fcharge, city, state, sterm, comments, podate, customer, part_no, rev, delto, ord_by, date1, dweek, po, our_ord_num, saletax, no_layer, sp_reqs, svia_oth, salesrep, commision, comval,pfid,fob) values('".$_REQUEST['vid']."','".$_REQUEST['sid']."', '".escpe($_REQUEST['namereq'])."', '".$_REQUEST['svia']."', '".$_REQUEST['fcharge']."', '".escpe($_REQUEST['city'])."', '".escpe($_REQUEST['state'])."', '".$_REQUEST['sterms']."', '".escpe($_REQUEST['area1'])."', '".date('m/d/Y')."', '".escpe($_REQUEST['customer'])."', '".$_REQUEST['part_no']."', '".$_REQUEST['rev']."', '".$_REQUEST['delto']."', '".$_REQUEST['ord_by']."', '".$_REQUEST['date1']."', '".$dweek."', '".$_REQUEST['po']."', '".$_REQUEST['oo']."', '".$_REQUEST['stax']."', '".$_REQUEST['lyrcnt']."', '".escpe($_REQUEST['specialreqval'])."', '".$_POST['svia_oth']."',  '".escpe($_POST['salesrep'])."', '".$_POST['commision']."', '".$_POST['totcomm']."', '-PF', '".$_POST['city1']."')";
...
<tr >
	...
	<td height="30" ><div style="float: left"><input name="city1" type="text" id="city_check_2"  size="30">
		<input style="display: none;" name="city" type="text" id="city_check_4"  size="30">
