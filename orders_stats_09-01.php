...
<div id="main" style='top: 55px; z-index: 10'>
	...
	<tr height='20'><td colspan='10' align='left'><a href="orders_stats.php">All Orders</a>&nbsp; &nbsp; :: &nbsp; &nbsp;<a href="orders_stats.php?withinv=yes">Orders with Invoice</a>&nbsp; &nbsp; :: &nbsp; &nbsp;<a href="orders_stats.php?withinv=no">Orders without Invoice</a>&nbsp; &nbsp; :: &nbsp; &nbsp;<a href="orders_stats.php?tbd=1">Orders TBD</a>&nbsp; &nbsp; :: &nbsp; &nbsp;<a href="manage_purchase.php?hidden=1" target='new'>Hidden PO Orders</a>&nbsp; &nbsp; :: &nbsp; &nbsp;<a href="manage_invoice.php?hidden=1" target='new'>Hidden Invoices</a><?php echo $excel_link.$excel_link2 ?></td></tr>
	</table>
...
while($rowp = mysql_fetch_assoc($resp)) {
	...
	echo "<tr style='height: 18px;".( strlen($rowp['dweek']) < 10 ? " background: #fee" : ($ct % 2 == 0 ? " background: #eee" : ""))."'>
		...
		<td width='3%'><form action='orders_stats.php' method='post' name='formact'><input type='hidden' name='act' value='".$rowp['poid']."'><input name='txtchk' type='checkbox' value='1' onchange='this.form.submit();'". ($rowp['allow'] == 1 ? 'checked="checked"' : '')." /></form></td>
