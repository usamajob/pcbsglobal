...
$sqdel='delete from enggcont_tb where enggcont_id="'.$_REQUEST['delid'].'"';
...
<head>
<title>Manage Engineering Contacts</title>
...
$sqc="select DISTINCT c_name ,data_id from data_tb order by c_name";
...
$sqs="select * from enggcont_tb where coustid='".$_REQUEST['txtcname']."'";
...
$query="select * from enggcont_tb";

if($_REQUEST['txtcname']!="")

{

$query="select * from enggcont_tb where coustid='".$_REQUEST['txtcname']."'";
...
?>
	  ...
	  <table class="manage" style="left:310px;" width="815" border="1" cellpadding="2" cellspacing="2" bordercolor="#e6e6e6">

	  <tr>
		<td height="30" colspan="6"><strong>MANAGE Engg Contacts </strong></td>
	  </tr>
	  ...
	  <tr>
		<td width="55" height="30" align="center"><strong>ID</strong></td>
		<td width="250" height="30" align="center"><strong>Customer Name</strong></td>

		<td width="245" height="30" align="center"><strong> Name</strong></td>

		<td width="105" align="center"><strong>Last Name</strong></td>

		<td width="80" height="30" align="center"><strong>Edit</strong></td>

		<td width="80" height="30" align="center"><strong>Delete</strong></td>
	  ...
	  while($rwc = mysql_fetch_array($res1)) {
			...
			$sqcc = "select * from data_tb where data_id='".$rwc['coustid']."'";

			$rescc = mysql_query($sqcc) or die('error in data');

			$rwcc = mysql_fetch_array($rescc);
	  ?>
	...
	<tr>
		...
		<td align="center"><?php echo $rwcc['c_name']; ?></td>
		<td align="center"><?php echo $rwc['name']; ?></td>

		<td align="center"><?php echo $rwc['lastname']; ?></td>

		<td align="center"><a href="edit_enggcontact.php?id=<?php echo $rwc['enggcont_id']; ?>">Edit</a></td>
