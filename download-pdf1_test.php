...
<table width="1500px" border="0">
   <tr> 
	...
	<td width="100"></td>
	<td> <h1 style="font-size: 40pt;color:#5660B1">Pending Orders</h1>	
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
Fax: (855) 262-5305<br>	
  ...
  <table width="1500px" border="0">
	...
	<td  width="320" style="background-color:#656BBC; color:#FFF;height:15px;" colspan="4">SOLD TO</td>
	<td  width="200"></td>
...
$messagee.=	'
	...
	<td width="0" height="5px" colspan="3"> 
	
	<table style="vertical-align:top;"  width="320" border="0">';
...
<tr style="background-color: #656BBC; color: #FFF; text-align: center"> 
	...
	<td width="40">REV</td>
	<td width="160">PURCHASE ORDER</td>
	<td width="120">SHIPPED ON</td>
...
<br>
	...
	$messagee .= nl2br($nrow['ntext']).'<br><br>';
}
