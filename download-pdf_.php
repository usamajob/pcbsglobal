...
<b>Quote Valid for : </b> 30 Days <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <tr>
    <td width="4"></td>
   <td width="279">
	 <strong>PCBsGlobal Incorporated.</strong><br>
...
Email: sales@pcbsglobal.com <br>
  ...
  <tr  style="background-color:#656BBC; color:#FFF; text-align: center; font-size: 18pt;">
    ...
    <td colspan="4"><br>
	  <p style="font-size: 12pt">Quotation is based on the following:</p>'.$nol.', '.$rws[board_size1].' X '.$rws[board_size2].' Board size with '.$rws[m_require].' Material and '.$rws[finish].' Finish <br>
