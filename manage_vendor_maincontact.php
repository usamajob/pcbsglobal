...
$sqdel = 'delete from vendor_maincont_tb where enggcont_id="'.$_REQUEST['delid'].'"';
...
<head>
<title>Manage Vendor Main Contacts</title>
...
if($_REQUEST['txtcname'] != "") {
	...
	$sqs="select * from vendor_maincont_tb where coustid='".$_REQUEST['txtcname']."'";
...
$query="select * from vendor_maincont_tb";

if($_REQUEST['txtcname'] != "") {

	$query = "select * from vendor_maincont_tb where coustid='".$_REQUEST['txtcname']."'";
...
<tr>
	<td height="30" colspan="5"><strong>MANAGE Vendor Main Contacts </strong></td>
</tr>
...
<tr>
	...
	<td height="30" align="center"><a href="edit_main.php?id=<?php echo $rwc['enggcont_id'];?>">Edit</a></td>
