...
$(document).ready(function() {
	...
	$("#Submit").click(function(e) {
		...
		if($.trim($('#txtpno').val()) != "") { 
			//&& $.trim($('#txtrev').val()) != ""
			var response = geturl("getalerts.php?pno="+ $.trim($('#txtpno').val()) + "&refid="+ <?php echo $_SESSION['refid'] ?>); 
			//+ "&rev="+ $.trim($('#txtrev').val())
...
?>
	...
	<form id="form1" name="form1" method="post" action="sendmail_manu.php">
	...
	<table width="880" border="1" cellpadding="1" cellspacing="1" bordercolor="#e6e6e6" class="up" style="left:35px;">
	<tr><td>
		<br /><strong>Cancellation</strong> <input type="checkbox" name="cancharge" value="yes">
		<!-- <input type="radio" name="" id="radio12">	Yes
		<input type="radio" name="cancharge" id="radio122" value="no"> 	No -->
    ...
    <tr>
		...
		<tr>
			...
			<td height="25" ><input type="checkbox" name="admcmntstat" value="yes" >
    ...
    <tr>
		...
		<input name="chki1" type="checkbox" id="chki1" value="1" /> 2
		<input name="chki2" type="checkbox" id="chki2" value="2" /> 3 
	...
	<tr>
        ...
        <br />
        <br />
		<strong>Fingers Nickel/Hard Gold: </strong> <input type="checkbox" name="chk25" value="yes"><!-- Yes <input name="chk25" type="radio" id="chk25" value="yes" />
		&nbsp;
		NO 
		...
		<input name="chk31" type="radio" id="chk31" value=".006" /> .005 
		<input name="chk31" type="radio" id="chk32" value=".005" /> .004 
		<input name="chk31" type="radio" id="chk33" value=".004" /> .003 
		...
		<br />
		<br />
		<strong>Controlled Impedance:</strong> <input type="checkbox" name="chk35" value="Yes"><!-- Yes 
		<input name="chk35" type="radio" id="chk35" value="Yes" /> No 
		...
		<br />
		<br />
		<strong>Blind Vias:</strong> <input type="checkbox" name="chk37" value="yes" ><!-- Yes 
		<input name="chk37" type="radio" id="chk37" value="yes" />
		&nbsp;
		No <input name="chk37" type="radio" id="chk38" value="No" />
		<br />
		<br /> -->&nbsp;&nbsp;
		<strong>Buried Vias:</strong> <input type="checkbox" name="chk39" value="yes" ><!-- Yes 
		...
		<br />
		<br /> -->
		<strong>HDI Design:</strong> <input type="checkbox" name="chk200" value="Yes" ><!-- Yes 
        <input name="chk200" type="radio" id="chk200" value="Yes" />
		No <input name="chk200" type="radio" id="chk201" value="No" /> -->
	   <br />
	   <br />
	   <strong>Non-Conductive Filled/Plated Over:</strong> <input type="checkbox" name="chk215" value="Yes" ><!-- <br>Yes 
       <input name="chk215" type="radio" id="chk215" value="Yes" />
		No <input name="chk215" type="radio" id="chk216" value="No" /> -->
	   <br />
	   <br />
		<strong>Conductive Filled Vias:</strong> <input type="checkbox" name="chk210" value="Yes" ><!-- Yes 
        <input name="chk210" type="radio" id="chk210" value="Yes" />
	...
	<tr>
		...
		White <input name="chk58" type="radio" id="chk58" value="White" />
		Black <input name="chk58" type="radio" id="chk59" value="Black" />  Yellow <input name="chk58" type="radio" id="chk60" value="Yellow" />
		<br />
		<br />
		<strong>Other:</strong>
	...
	<tr>
		<td height="25"><strong>Individual Route 1-up: </strong><input type="checkbox" name="chk61" value="Yes" ><!-- Yes 
		...
		<br />
		<br />
		<strong>Array:</strong> <input type="checkbox" name="chk63" value="YES" ><!-- Yes 
		...
		<br />
		<strong>Rout Tolerance:</strong> +/-.005 <input name="chk204" type="radio" id="chk204" value="+/-.005" /> Other 
		<input name="chk204" type="radio" id="chk205" value="Other" />
		<input name="txtother52" type="text" id="txtother53" size="2" />    </td>

		<td height="25"><strong>Array Design Provided:</strong> <input type="checkbox" name="chk65" value="Yes" ><!-- Yes
		<input name="chk65" type="radio" id="chk65" value="Yes" /> 
		&nbsp; No
		<input name="chk65" type="radio" id="chk66" value="No" /> -->
		<br /><br />
		<strong>Factory to Design Array: </strong><input type="checkbox" name="chk67" value="yes" ><!-- Yes 
		...
		<td height="25"><strong>Milling: </strong><input type="checkbox" name="chk75" value="yes" ><!-- Yes 
		<input name="chk75" type="radio" id="chk75" value="yes" />
		&nbsp; No
		<input name="chk75" type="radio" id="chk76" value="No" /> -->
		<br />
		<br />
		<strong>Countersink:</strong> <input type="checkbox" name="chk77" value="yes" ><!-- Yes
		<input name="chk77" type="radio" id="chk77" value="yes" /> 
		&nbsp; No
		<input name="chk77" type="radio" id="chk78" value="No" /> -->
		<br />
		<br />
		<strong>Control Depth:</strong> <input type="checkbox" name="chk79" value="Yes" ><!-- Yes
		<input name="chk79" type="radio" id="chk79" value="Yes" /> 
		&nbsp; No
		<input name="chk79" type="radio" id="chk80" value="No" /> -->
		<br />
		<br />
		<strong>Edge Plating:</strong> <input type="checkbox" name="chk81" value="Yes" ><!-- Yes
    ...
    <tr>
		...
		Factory <input name="chk83" type="radio" id="chk84" value="Factory" /> Other 
		<input name="chk83" type="radio" id="chk214" value="Other" />
		<input name="txtother56" type="text" id="txtother56" size="3" />
		<br />
		<br />
		<strong>94V-0 Mark: </strong><input type="checkbox" name="chk85" value="Yes" ><!-- Yes 
		...
		<br /></td>
		<td height="25"><strong>Microsection Required:</strong> <input type="checkbox" name="chk90" value="YES" ><!-- Yes 
		<input name="chk90" type="radio" id="chk90" value="YES" />
		&nbsp;
		No <input name="chk90" type="radio" id="chk91" value="NO" /> -->
		<br />
		<br />
		<strong>Electrical Test Stamp: </strong><input type="checkbox" name="chk92" value="Yes" ><!-- Yes
		...
		<td height="25"><strong>X-Outs Allowed:</strong> <input type="checkbox" name="chk95" value="yes" ><!-- Yes
		...
		<br /><br />
		<strong>RoHS Cert:</strong> <input type="checkbox" name="chk97" value="Yes" ><!-- Yes 
