...
if($_REQUEST['dupid'] != "") {
	...
	echo "<script type='text/javascript'>location.href='cancelled_purchase.php'</script>";
}
?>
...
function del(id) {
	...
	if(answer) 
		location.href = "cancelled_purchase.php?delid="+id;
	else 
		return false;
}
</script>
...
// print the navigation link 
	...
	<tr>
	  <td height="30" colspan="5"><font size="3"><strong>MANAGE CANCELLED PURCHASE ORDERS</strong></font></td>
	...
	<tr>
	  ...
	  <td width="107" align="center"><strong>Cancellation Date</strong></td>
