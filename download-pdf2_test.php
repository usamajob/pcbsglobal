...
<table width="1500px" border="0">
   <tr> 
	...
	<h1 style="font-size: 33pt;color:#5660B1">Pending Invoices</h1>
	<!--<br>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;
...
<table width="1500px" border="0">
<tr> 
    <td  width="300" style="background-color:#fff; color:#FFF;" colspan="2"></td>  
	<td  width="50"></td>
...
<table width="1500px" border="0">
   <tr style="background-color:#656BBC;color:#FFF;text-align:center;font-size:11pt;"> 
    <td style="padding-top:5px;padding-bottom:5px;" >ITEM #</td> 
	<td  width="150">PART NUMBER</td>
	<td  >REV</td>
	<!--<td  width="30">LYRS</td>-->
	<td  >Pur Order</td><!-- value comes from -->
...
//*********** wrote a function fix the probe
	$tot=0;
	function drawTableRow(){
		...
		while($rwi = mysql_fetch_assoc($resi)){
			...
			if($j==0){
				$messagee.= "<tr>";
				$messagee.= "<td>".$rwi['item']."</td>";
				$messagee.= "<td width='160'>".$rws['part_no']."</td>";
				$messagee.= "<td width='40' align='center'>".$rws['rev']."</td>";
				$messagee.= "<td width='120' align='center'>".$rws['po']."</td>";
				$messagee.= "<td width='80' align='center'>".$done_date."</td>";
				$messagee.= "<td width='70' align='center'>".($rws['invoice_id']+9976)."</td>";
				$messagee.= "<td width='80' align='center'>".$done_date."</td>";
		...
		$messagee.= '<td text=align="right" width="100">$'.format_num($tot).'&nbsp;&nbsp;</td>';
		$messagee.= "</tr>";
...
$messagee.='  '.
	...
	<td  width="70" >'.($rws['invoice_id']+9976) .'</td>
	<!--<td  width="90"  align="right" style="text-align:right">  $'.format_num($rwi['uprice']).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>-->
	<td  width="90"  align="center" style="text-align:center">  '.$done_date.'</td>
...
$is_first_time=false;
}//end if is first time if condition
...
<strong>Comments</strong><br>'.$rws['comments']. 
    ...
    <p style="font-size: 12pt;text-align:center;margin-top:320px;">
