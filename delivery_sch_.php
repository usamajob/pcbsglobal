...
//$query="select * from order_tb where ( req_by  LIKE '$ord_by') limit 1";
                ...
                <div id="main2">
                    ...
                    <div style="width:6.5%;" id="left2"><?php echo ($rws['part_no'] != '') ? $rws['part_no'] : '&nbsp;'; ?></div>
                    <div style="width:2.5%;" id="left2"><?php echo ($rws['rev'] != '') ? $rws['rev'] : '&nbsp;'; ?></div>
                    ...
                    <div style="width:7%;" id="left2"><?php echo ($ypo != '') ? $ypo : '&nbsp;'; ?></div>
                    <div style="width:6%;" id="left2"> <?php echo ($po != '') ? $po : '&nbsp;'; ?> 
                    ...
                    <div id="left2">
                    	...
                    	<a href="download-pdf3.php?id=<?php echo $rws['invoice_id']; ?>&oper=view">V</a>
                        <a href="edit_packing.php?id=<?php echo $rws['invoice_id']; ?>">E</a> 
                        <a href="download-pdf3.php?id=<?php echo $rws['invoice_id']; ?>">D</a>
                        <?php } ?>
                    </div>
                    <div style="width:6%;" id="left2">
                    ...
                    <div style="width:7%;" id="left2"><?php echo ($shipvia != '') ? $shipvia : '&nbsp;'; ?></div>
                    <div id="left2"><?php echo ($vendor_shortname != '') ? $vendor_shortname : '&nbsp;'; ?></div>
                    <div style="width:7%;" id="left2"><?php echo ($delto != '') ? $delto : '&nbsp;'; ?></div>
                    <div style="width:7%;" id="left2"><?php echo ($delivered_on != '') ? $delivered_on : '&nbsp;'; ?></div>
                    <div id="left2"><?php echo ($rws['podate'] != '') ? $rws['podate'] : '&nbsp;'; ?></div>
                    <div style="width:5%;" id="left2"><?php echo ($tot2 != '') ? $tot : '&nbsp;'; ?></div>
                    <div style="width:5%;" id="left2"><?php echo ($tot33 != '') ? $tot33 : '&nbsp;'; ?></div>
                    <div style="width:5%;" id="left2">
                        <?php
