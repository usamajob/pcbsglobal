...
/*	$sqs="select a.customer,a.part_no,a.rev,a.ord_by,a.date1,a.delto,a.our_ord_num,a.svia,b.poid,b.po,a.sid,a.invoice_id,b.dweek,
	...
	$sqs="select  b.poid,b.namereq1, b.customer,b.namereq,b.part_no,b.rev,c.ord_by,b.date1,c.delto,c.our_ord_num,c.svia,b.poid,b.po,b.sid,c.podate,c.invoice_id,b.dweek,
    ...
    $rowColor = "#F4F5FD"; 
																...
																$tt++;	 
																  ...
																  //  $invoice_id = $rws['invoice_id'];
																   ...
																   $sql_pack = "SELECT COUNT(*) as cnt ,date1 FROM packing_tb WHERE rev='$rev' and part_no='$pno'";
