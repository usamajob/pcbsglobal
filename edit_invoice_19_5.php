...
$dweek= substr($_REQUEST['date1'], -10);  // abcd
  $sqin="update invoice_tb set vid='".$_REQUEST['vid']."',sid='".$_REQUEST['sid']."',namereq='".$_REQUEST['namereq']."',svia='".$_REQUEST['svia']."',fcharge='".$_REQUEST['fcharge']."',city='".$_REQUEST['city']."',state='".$_REQUEST['state']."',sterm='".$_REQUEST['sterms']."',comments='".$_REQUEST['comments']."',date1='".$_REQUEST['date1']."',dweek='".$dweek."',po='".$_REQUEST['po']."',customer='".$_REQUEST['customer']."',part_no='".$_REQUEST['part_no']."',rev='".$_REQUEST['rev']."',delto='".$_REQUEST['delto']."',ord_by='".$_REQUEST['ord_by']."',our_ord_num='".$_REQUEST['oo']."',saletax='".$_REQUEST['stax']."' where invoice_id='".$_REQUEST['id']."'";
...
<input name="inid" id="inid" type="hidden" value="<?php echo $rws['invoice_id'];?>" >
                                                  ...
                                                  <table class="purchase" width="700" border="1" cellpadding="2" cellspacing="2" bordercolor="#e6e6e6" style="left:30px;">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td height="30" colspan="2"><strong>EDIT INVOICE FORM</strong></td>
                                                    </tr>
...
$po='';                                                   
                    ?>                                
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td height="30"><!--<input  name="oo" type="text" id="oo" value="<?php echo $rws['our_ord_num'];?>" size="30">--><select name="oo">
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td height="30"><!--<input  name="po" type="text" id="po" value="<?php echo $rws['po'];?>" size="30">--><select name="po">
                                                      <option value="">--select--</option>
                                                        <?php 
													 $sqo="select DISTINCT po from packing_tb where ( part_no='".$rws['part_no']."') and (rev='".$rws['rev']."')";
