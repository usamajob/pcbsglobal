...
echo $qry_update_duplicate_porder_date="UPDATE porder_tb  set podate='".date('m/d/Y')."' Where poid=".$duplicate_porder_id;
...
?>
                                                  ...
                                                  <table width="950" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#e6e6e6">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td height="30" colspan="6"><font size=3><strong>MANAGE PURCHASE ORDER</strong></font></td>
