...
//$query="select * from order_tb where ( req_by  LIKE '$ord_by') limit 1";
                ...
                $inc++;
                ?>
                <div id="main2" <?php echo ($inc % 2 == 0) ? 'style="background:#0489B1;"':'#ffffff;'; ?> >
                    <div id="left2">
                        <?php // echo  $tttemp.$tttemp2; ?>
                        <a class="ttip_overlay_trig" <?php echo ($inc % 2 == 0) ? 'style="color:#FFBF00;"':'#FFBF00;'; ?> href="javascript:void(0)"><?php echo ($rws1['c_shortname'] != '') ? $rws1['c_shortname'] : '&nbsp;'; ?></a>
                    ...
                    <div id="left4" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>><?php echo ($rws['part_no'] != '') ? $rws['part_no'] : '&nbsp;'; ?></div>
                    <div id="left5" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>><?php echo ($rws['rev'] != '') ? $rws['rev'] : '&nbsp;'; ?></div>
                    <div id="left2"><a class="ttip_overlay_trig" <?php echo ($inc % 2 == 0) ? 'style="color:#FFBF00;"':'#FFBF00;'; ?> href="javascript:void(0)"><?php echo ($rws['namereq1'] != '') ? $rws['namereq1'] : '&nbsp;'; ?></a>
                        <div class="ttip_overlay" style="position:absolute;margin-top:-10px;background:#eee;padding:5px;width:300px;display:none;z-index: 99999"> <a href="javascript:void(0)" class="ttip_overlay_close_trig" style="color:#cd0000;float:right">Close</a>
                            <div>
                                <p>
                                    <?php
                    ...
                    <div id="left2" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>>
                        <?php
                        $duedate1 = $rws['date1'];
                    ...
                    <div id="left6" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>><?php echo ($ypo != '') ? $ypo : '&nbsp;'; ?></div>
                    <div id="left7" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>> <?php echo ($po != '') ? $po : '&nbsp;'; ?> 
                        <a href="download-pdf1.php?id=<?php echo $rws['poid']; ?>&oper=view" <?php echo ($inc % 2 == 0) ? 'style="color:#FFBF00;"':'#FFBF00;'; ?>>V</a>
                        <a href="edit_purchase.php?id=<?php echo $rws['poid']; ?>" <?php echo ($inc % 2 == 0) ? 'style="color:#FFBF00;"':'#FFBF00;'; ?>>E</a> 
                        <a href="download-pdf1.php?id=<?php echo $rws['poid']; ?>" <?php echo ($inc % 2 == 0) ? 'style="color:#FFBF00;"':'#FFBF00;'; ?>>D</a>
                    </div>
                    <div id="left2" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>>
						<?php //echo $rws['invoice_id'] + 9987; ?>
						<?php echo ($rws['invoice_id'] != '') ? ($rws['invoice_id']+9987) : '&nbsp;'; ?>
						<?php if($rws['invoice_id'] != '') { ?>
                    	<a href="download-pdf3.php?id=<?php echo $rws['invoice_id']; ?>&oper=view" <?php echo ($inc % 2 == 0) ? 'style="color:#FFBF00;"':'#FFBF00;'; ?>>V</a>
                        <a href="edit_packing.php?id=<?php echo $rws['invoice_id']; ?>" <?php echo ($inc % 2 == 0) ? 'style="color:#FFBF00;"':'#FFBF00;'; ?>>E</a> 
                        <a href="download-pdf3.php?id=<?php echo $rws['invoice_id']; ?>" <?php echo ($inc % 2 == 0) ? 'style="color:#FFBF00;"':'#FFBF00;'; ?>>D</a>
                        <?php } ?>
                    </div>
                    <div id="left8" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>>
						<?php echo ($rws['invoice_id'] != '') ? ($rws['invoice_id']+9976) : '&nbsp;'; ?>
                        <?php if($rws['invoice_id'] != '') { ?>
                    	<a href="download-pdf2.php?id=<?php echo $rws['invoice_id']; ?>&oper=view" <?php echo ($inc % 2 == 0) ? 'style="color:#FFBF00;"':'#FFBF00;'; ?>>V</a>
                        <a href="edit_invoice.php?id=<?php echo $rws['invoice_id']; ?>" <?php echo ($inc % 2 == 0) ? 'style="color:#FFBF00;"':'#FFBF00;'; ?>>E</a> 
                        <a href="download-pdf2.php?id=<?php echo $rws['invoice_id']; ?>" <?php echo ($inc % 2 == 0) ? 'style="color:#FFBF00;"':'#FFBF00;'; ?>>D</a>
                        <?php } ?>
                    </div>
                    <div id="left6" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>><?php echo ($shipvia != '') ? $shipvia : '&nbsp;'; ?></div>
                    <div id="left2" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>><?php echo ($vendor_shortname != '') ? $vendor_shortname : '&nbsp;'; ?></div>
                    <div id="left6" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>><?php echo ($delto != '') ? $delto : '&nbsp;'; ?></div>
                    <div id="left6" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>><?php echo ($delivered_on != '') ? $delivered_on : '&nbsp;'; ?></div>
                    <div id="left2" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>><?php echo ($rws['podate'] != '') ? $rws['podate'] : '&nbsp;'; ?></div>
                    <div id="left9" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>><?php echo ($tot2 != '') ? $tot : '&nbsp;'; ?></div>
                    <div id="left9" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>><?php echo ($tot33 != '') ? $tot33 : '&nbsp;'; ?></div>
                    <div id="left9" <?php echo ($inc % 2 == 0) ? 'style="color:#FFFFFF;"':'#FFFFFF;'; ?>>
                        <?php
