...
if( isset($_GET['hidden']) && $_GET['hidden'] == '1') {
	$sqs = "select * from porder_tb where status='hide'";
	$sqs .= " ORDER BY poid desc LIMIT $offset, $rowsPerPage ";
}
...
if($_REQUEST['srchv']!="") {
	$sqs="select * from porder_tb,vendor_tb where porder_tb.vid=vendor_tb.data_id and vendor_tb.c_name like '%".$_REQUEST['srchv']."%'";
...
if($_REQUEST['srchv'] != "") {
	$query="select * from porder_tb,vendor_tb where porder_tb.vid=vendor_tb.data_id and vendor_tb.c_name like '%".$_REQUEST['srchv']."%'";
}
...
// print the navigation link 
	...
	<tr>
	  ...
	  <td height="30" colspan="7"> <a href="manage_purchase.php">CLEAR SEARCH FILTERS</a></td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td width="76" height="30" align="center"><strong>Pending</strong></td>
	</tr>
	<?php 
	...
	<tr>
	  ...
	  <td align="center">
	  	<a target="_blank" href="download-pdf1.php?id=<?php echo $rwc['poid'];?>&amp;oper=view">
	  		VIEW PDF
	  	</a>
	  	<a target="_blank" href="download-pdf1_test.php?id=<?php echo $rwc['poid'];?>&amp;oper=view">
	  		[test]
	  	</a>
	  </td>
	  ...
	  <td align="center"><input type="checkbox" name="" id=""  <?php echo ($rwc['is_processed']=='Yes')?"checked=\"checked\"":""; ?>  value="<?php echo $rwc['poid']; ?>" title="is processed" onclick="doAction(this.value,this.checked);"/></td>
	</tr>
	<?php 
	}
	?>
